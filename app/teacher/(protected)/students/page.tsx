                        ...
                        {editingStudent?.id === student.id ? (
                          ...
                          >
                            <input
                              ...
                              className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all w-64"
